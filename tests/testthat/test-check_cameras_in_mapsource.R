describe("Check cameras", {
  ...
  it("Get error if cameras in mapsource are not in revision_campo", {
    expect_error(check_cameras_in_mapsource(two_cameras_in_revision_campo, listed_cameras_in_mapsource), "🚨 Los IDs CT-01-001-CF en mapsource no están en el revision_campo 🚨")
  })
})
