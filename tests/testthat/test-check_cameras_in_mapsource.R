describe("Check cameras", {
  ...
  it("Get message if cameras in mapsource are in revision_campo", {
    expect_message(check_cameras_in_mapsource(cameras_in_revision_campo_green, listed_cameras_in_mapsource), "💚 Todas las cámaras están en el revision_campo 💚")
  })
  ...
  it("Get error if cameras in mapsource are not in revision_campo", {
    expect_error(check_cameras_in_revision_campo(two_cameras_in_revision_campo, listed_cameras_in_mapsource), "🚨 Los IDs CT-01-001-CF en mapsource no están en el revision_campo 🚨")
  })
})
