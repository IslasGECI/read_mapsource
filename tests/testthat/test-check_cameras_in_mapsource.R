describe("Check cameras", {
  ...
  it("check if cameras in revision_campo are in mapsource", {
    ...
    expect_error(check_cameras_in_mapsource(cameras_in_revision_campo, listed_cameras_in_mapsource), "🚨 Error en los IDs 🚨")
    check_cameras_in_mapsource(cameras_in_revision_campo_green, listed_cameras_in_mapsource)
