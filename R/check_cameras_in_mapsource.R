...
check_cameras_in_mapsource <- function(cameras_in_revision_campo, cameras_in_mapsource) {
  missing_ids <- get_missing_ids_in_mapsource(cameras_in_revision_campo[["ID_camara"]], cameras_in_mapsource[["Name"]])
...
get_missing_ids_in_mapsource <- function(cameras_ids, mapsource_ids) {
